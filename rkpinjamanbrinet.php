...
<div style="display:none;" id="spinner-preview"></div><!-- spin.js -->
		...
		<input type="hidden" id="key" name="key" value="00174122ip=rs2.portaldwh.bri.co.id&addr=%2fReportRekeningKoranHarian%2fREKENING_KORAN%2fLOAN_RC" />
		<input type="hidden" id="client_ip" name="client_ip" value="192.168.67.29" />
        <input type="hidden" id="reportAddr" name="reportAddr" value="/ReportRekeningKoranHarian/REKENING_KORAN/LOAN_RC" />
		<input type="hidden" id="reportIp" name="reportIp" value="172.18.41.63" />
		<input type="hidden" id="QueryStr" name="QueryStr" value="ip=rs2.portaldwh.bri.co.id&addr=%2fReportRekeningKoranHarian%2fREKENING_KORAN%2fLOAN_RC" />
        </form>
		</body>
