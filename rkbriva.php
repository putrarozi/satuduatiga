...
<div style="display:none;" id="spinner-preview"></div><!-- spin.js -->
		...
		<input type="hidden" id="key" name="key" value="00174122ip=rs2.portaldwh.bri.co.id&addr=/REKENING_KORAN%2fDD_ONLINE_BRIVA" />
		<input type="hidden" id="client_ip" name="client_ip" value="192.168.67.29" />
        <input type="hidden" id="reportAddr" name="reportAddr" value="/REKENING_KORAN/DD_ONLINE_BRIVA" />
		<input type="hidden" id="reportIp" name="reportIp" value="rs2.portaldwh.bri.co.id" />
		<input type="hidden" id="QueryStr" name="QueryStr" value="ip=rs2.portaldwh.bri.co.id&addr=/REKENING_KORAN%2fDD_ONLINE_BRIVA" />
        </form>
		</body>
