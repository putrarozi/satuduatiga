...
<div style="display:none;" id="spinner-preview"></div><!-- spin.js -->
		...
		<input type="hidden" id="key" name="key" value="00174122ip=rs2.portaldwh.bri.co.id&addr=%2fREKENING_KORAN%2fLN_ONLINE" />
		<input type="hidden" id="client_ip" name="client_ip" value="172.18.41.63" />
        <input type="hidden" id="reportAddr" name="reportAddr" value="/REKENING_KORAN/LN_ONLINE" />
		<input type="hidden" id="reportIp" name="reportIp" value="rs2.portaldwh.bri.co.id" />
		<input type="hidden" id="QueryStr" name="QueryStr" value="ip=rs2.portaldwh.bri.co.id&addr=%2fREKENING_KORAN%2fLN_ONLINE" />
        </form>
		</body>
