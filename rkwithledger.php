...
<div style="display:none;" id="spinner-preview"></div><!-- spin.js -->
        <form name="FrmSendSession" id="FrmSendSession" action="http://rs1.portaldwh.bri.co.id" method="post">
        <!--input type="hidden" id="UserId" name="UserId" value="00174122" />
        <input type="hidden" id="Role" name="Role" value="AIN" />
        <input type="hidden" id="UkerF" name="UkerF" value="0" />
        <input type="hidden" id="RgCode" name="RgCode" value="" />
        <input type="hidden" id="Divisi" name="Divisi" value="KNSPKB" />
        <input type="hidden" id="AuthorizedPages" name="AuthorizedPages" value="PDM_MAIN.ASPREKKORAN.ASPPDM_PROF_MGMT.ASPPDM_PROFILE.ASPPDM_FAQ.ASPSAPCV.ASPPDM_KERAGAAN_KANCA.ASPMERCHANT_EDC_VIEW.ASPPDM_KERAGAAN_UNIT.ASPREKKORAN.ASPPDM_FIXRPT_SUBJEKAREA.ASPPDM_MONITORING_ECHANNEL.ASPVIEW_UPLOAD_FILES.ASPLBU_REPORT_PERKANTOR.ASPLBU_IA_EXCP.ASPLBU_IA_MAINTANANCE.ASPLBU_ER_CIF.ASPLBU_MAINTAIN_COA.ASP" /-->
		<input type="hidden" id="user_id" name="user_id" value="00174122" />
		<input type="hidden" id="app_name" name="app_name" value="Portal DWH" />
		<input type="hidden" id="key" name="key" value="00174122ip=rs2.portaldwh.bri.co.id&addr=/ReportRekeningKoranHarian/REKENING_KORAN/DD_ONLINE_WITH_LADGER" />
		<input type="hidden" id="client_ip" name="client_ip" value="172.18.41.63" />
        <input type="hidden" id="reportAddr" name="reportAddr" value="/ReportRekeningKoranHarian/REKENING_KORAN/DD_ONLINE_WITH_LADGER" />
		<input type="hidden" id="reportIp" name="reportIp" value="rs2.portaldwh.bri.co.id" />
		<input type="hidden" id="QueryStr" name="QueryStr" value="ip=rs2.portaldwh.bri.co.id&addr=/ReportRekeningKoranHarian/REKENING_KORAN/DD_ONLINE_WITH_LADGER" />
        </form>
		</body>
